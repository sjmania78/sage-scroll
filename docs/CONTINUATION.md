...
- **적재 80인 51개국** (전세계 8권역). 한국 23 + 동아시아 6 + 유럽 25 + 아메리카 10 + 서아시아 3 + 남·동남아 6 + 아프리카 5 + 오세아니아 2.
- **한 인물당 마커 1개**(첫 연고지). 79/80 마커(최한기만 없음=정상, 북한 개성·검증 연고지 없음). 생애지도(연표 📍→지도 이동) 작동. 지도 fitBounds 전세계.
- **메뉴 = 2축 탭**(app.js): `#region-tabs`(지역 8권역, `NATION_REGION` ISO2→권역) + `#era-tabs`(시대 5단계, `eraOf` birth_year: 고대<600·중세<1400·근세<1700·18–19세기<1880·근현대). 두 축 AND 교차 필터(`refreshList`). 둘 다 '전체'면 힌트+세계뷰.
- 인물 인덱스 분야 4그룹(사상·학문/시인·문인/화가·예술/국민 위인). 시인·문인 비대 — 지역·시대 탭으로 좁혀서 해소.
